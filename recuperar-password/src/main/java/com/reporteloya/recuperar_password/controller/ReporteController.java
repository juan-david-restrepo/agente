...
import com.reporteloya.recuperar_password.service.ReporteService;
...
public class ReporteController {
    ...
    @GetMapping("/agente")
    public ResponseEntity<?> obtenerReportesAgente(Authentication authentication) {
        ...
        return ResponseEntity.ok(
                reporteService.obtenerReportesParaAgente(placaAgente));
    }
